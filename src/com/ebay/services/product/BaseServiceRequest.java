...
@XmlSeeAlso({
    FindProductsByCompatibilityRequest.class,
    AddProductsRequest.class,
    GetProductCompatibilitiesRequest.class,
    FindProductsRequest.class,
    FindCompatibilitiesBySpecificationRequest.class,
    GetProductDetailsRequest.class,
